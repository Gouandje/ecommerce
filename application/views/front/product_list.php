		...
		<div class="product-image-wrapper">
			<div class="single-products">
				<div class="productinfo text-center">
					...
					<h2><?php echo $value->pro_price?>&nbspFCFA</h2>
				...
				<div class="product-overlay">
					...
					<form action="<?php echo base_url()?>add-to-cart"  method="post">
							<h2><?php echo $value->pro_price?>&nbspFCFA</h2><!--This is under form because style factor when product price move to form then style is not formating-->
							<p><?php echo $value->pro_title?></p>
