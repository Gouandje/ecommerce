...
/*Spec*/
$route['add-spec'] = 'Spec/add_spec_form';
$route['save-spec'] = 'Spec/save_spec';
$route['spec-list'] = 'Spec/show_spec_list';
$route['edit-spec/(.+)'] = 'Spec/edit_spec/$1';
$route['update-spec/(.+)'] = 'Spec/update_spec/$1';
$route['delete-spec/(.+)'] = 'Spec/delete_spec/$1';
