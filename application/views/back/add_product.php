                           ...
                           <h5 style='color:red'> <?php echo validation_errors();?></h5>
                             <?php echo form_open_multipart('save-product','');?>
                                <div class="form-group">
                                    <label>Ajouter Titre du Produit</label>
                                    <input type="text" class="form-control" value="" name="pro_title" required="">
                                </div>
                                 <div class="form-group">
                                    <label>Ajouter Description du Produit</label>
                                ...
                                <div class="form-group">
                                    <label>Selectionner la Sous Catégorie</label>
                                 ...
                                 <div class="form-group">
                                    <label>Ajouter le Prix du Produit</label>
                                    <input type="number" class="form-control" value="" name="pro_price" required="">
                                </div>
                                 <div class="form-group">
                                    <label>Ajouter la Quantité du Produit</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="pro_availability">
                                        ...
                                        <option value="2">Epuisé</option>
                                        <option value="3">Up Comming</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Charger l'Image du Produit</label>
