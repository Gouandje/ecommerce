<div class="features_items"><!--features_items-->
	<h2 class="title text-center"> produits à la une</h2>
		...
		<div class="product-image-wrapper">
			<div class="single-products">
				<div class="productinfo text-center">
					...
					<h2><?php echo $product->pro_price?>&nbsp FCFA</h2>
				...
				<div class="product-overlay">
					...
					<form action="<?php echo base_url()?>add-to-cart"  method="post">
							<h2><?php echo $product->pro_price?>&nbsp FCFA</h2><!--This is under form because style factor when product price move to form then style is not formating-->
							<p><?php echo $product->pro_title?></p>
			...
			<div class="choose">
				<ul class="nav nav-pills nav-justified">
					<li><a href="#"><i class="fa fa-plus-square"></i>Ajouter à liste des souhaits</a></li>
