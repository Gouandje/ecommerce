...
<head>
    ...
    <link href="<?php echo base_url()?>assets/back/css/admincss.css" rel="stylesheet" />
...
<body>
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        ...
                        <li>
                            <a class="text-center" href="<?php echo base_url()?>contact-message-list">
                                <strong>Lire Tous le Messages</strong>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="selected">
                        <a href="<?php echo base_url();?>dashboard"><i class="fa fa-dashboard fa-fw"></i>Tableau de bord d'administration</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>register-form"><i class="fa fa-user-plus fa-fw"></i>Enregistrer un utilisateur</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-tags fa-fw"></i> Option Catégories<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                 <a href="<?php echo base_url();?>add-category"><i class=""></i>Ajouter Catégorie</a>
                             </li>
                             <li>
                                 <a href="<?php echo base_url();?>add-sub-category"><i class=""></i>Ajouter Sous Catégorie</a>
                             </li>
                            <li>
                                 <a href="<?php echo base_url();?>category-list"><i class=""></i>Liste des Catégories</a>
                            </li>
                            <li>
                      ...
                      <li>
                        <a href="#"><i class="fa fa-product-hunt fa-fw"></i> Option Products<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                 <a href="<?php echo base_url();?>add-product"><i class=""></i>Ajouter Product</a>
                             </li>
                            <li>
                                 <a href="<?php echo base_url();?>product-list"><i class=""></i> Liste des Product</a>
                            </li>
                        </ul>
                    </li>

                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Option Marques<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo base_url();?>add-brand">Ajouter une marque</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>brand-list">Liste des Marques</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Option Caractéristique<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo base_url();?>add-spec">Ajouter une Caractéristique</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>spec-list">Liste des Caractéristique</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                     <li>
                        <a href="<?php echo base_url()?>manage-order"><i class="fa fa-flask fa-fw"></i>Gestion des commandes</a>
                    </li>
                </ul>
                <!-- end side-menu -->
            </div>
    ...
    <script src="<?php echo base_url()?>assets/back/scripts/admincustom.js"></script>
