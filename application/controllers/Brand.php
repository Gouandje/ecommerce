...
class Brand extends CI_Controller{
	...
	$this->session->set_flashdata("flsh_msg","<font class='success'>Marque Ajoutée avec succès</font>");
           redirect('brand-list');
		}else{
			$this->add_brand_form();
		}
	...
	public function delete_brand($brand_id){
		...
		$this->session->set_flashdata("flsh_msg","<font class='success'>Marque supprimée avec succès</font>");
           redirect('brand-list');
	}
	...
	public function update_brand($brand_id){
		...
		$this->session->set_flashdata('flsh_msg','Marque Modifiée avec succès',10);
