...
class Product extends CI_Controller{
	...
	$this->session->set_flashdata("flsh_msg","<font class='success'>produit Ajouté succès</font>");
	...
	public function update_product(){
		...
		if($_FILES['pro_image']['name']=="" || $_FILES['pro_image']['size']==""){
			...
			$this->session->set_flashdata("update_pro_msg","produit Modifié avec succès");
	...
	public function delete_product($product_id){
		...
		$this->session->set_flashdata('product_delete','produit Supprimé succès');
		redirect('product-list');
	}
