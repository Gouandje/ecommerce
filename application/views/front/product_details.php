		...
		<div class="product-information"><!--/product-information-->
			...
			<span>
				<form action="<?php echo base_url()?>add-to-cart"  method="post">
					<span><?php echo $product_info->pro_price?>&nbsp FCFA</span><!--This is under form because style factor when product price move to form then style is not formating-->
