				...
				<table class="table table-condensed">
					...
					<tbody>
						...
						<tr>
							...
							<td class="cart_price">
								<p><?php echo $items['price']?>&nbsp FCFA</p>
							</td>
							...
							<td class="cart_total">
								<p class="cart_total_price"><?php echo $items['subtotal']?>&nbsp FCFA</p>
							</td>
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							?>
							<li>Cart Sub Total <span><?php echo $cart_total;?>&nbsp FCFA</span></li>
							<?php
								$tax = ($cart_total*2)/100;
							?>
							<li>Eco Tax 2% <span><?php echo $tax?>&nbsp FCFA</span></li>
							...
							?>
							<li>Shipping Cost <span><?php echo $shiping?>&nbsp FCFA</span></li>
